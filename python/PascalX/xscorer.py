...
class crosscorer(ABC):
    ...
    def plot_genesnps(self,G,E_A,E_B,rank=False,zscore=False,show_correlation=False,mark_window=False,MAF=None):
        """
        ...
        if show_correlation:
            ...
            sns.heatmap(corr,cmap=cmap,square=True, vmin=-1,vmax=+1,xticklabels=10,yticklabels=10)
